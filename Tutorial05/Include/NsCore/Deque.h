...
////////////////////////////////////////////////////////////////////////////////////////////////////
// Partial template specialization to disable buffers of size 0
////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename T, typename Allocator>
class deque_node<T, Allocator,0 >
{
public:
    enum HeadPos
    {
...
public:
    deque_node<T, Allocator, 0>(HeadPos)
    {
        NS_STATIC_ASSERT(false, DEQUE_KNODESIZE_MUST_BE_GREATER_THAN_0);
    }
};
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template <typename T, typename Allocator, size_t kNodeSize>
class NsDeque : public Noesis::Core::nstl::deque<T, Allocator, kNodeSize>
{
private:
    typedef NsDeque<T, Allocator, kNodeSize> ThisType;
    typedef Noesis::Core::nstl::deque<T, Allocator, kNodeSize> BaseType;
