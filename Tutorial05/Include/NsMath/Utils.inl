...
// In GCC <cmath> nukes isfinite macro from <math.h>
#include <cmath>
using std::isfinite;
#endif
...
{
#if defined(NS_COMPILER_GCC) || (defined(NS_COMPILER_MSVC) && NS_COMPILER_VERSION >= 1800)
    return isnan(val);
#else
    return _isnan(val) != 0;
#endif
...
extern NS_MATH_UTILS_API NsUInt32 gFastRandSeed;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
inline NsFloat32 FRandFast()
{
    gFastRandSeed = 1664525L * gFastRandSeed + 1013904223L;
    
    IntFloatUnion t;
    t.i = 0x3f800000 | (0x007fffff & gFastRandSeed);
    return t.f - 1.0f;
}
