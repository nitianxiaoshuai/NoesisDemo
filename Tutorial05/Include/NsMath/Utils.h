...
/// Seeds the random sequence generated by FRandFast
NS_MATH_UTILS_API void FRandFastInit(NsUInt32 seed);

/// \return a random float between 0.0 and 1.0 (inclusive). This is a faster implementation than
/// FRand() but the distribution is probably slightly worst
