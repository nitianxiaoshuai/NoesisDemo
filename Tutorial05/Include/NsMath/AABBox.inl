...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
AABBox2<T>::AABBox2(const AABBox2& v): mMin(v.mMin), mMax(v.mMax)
{
}
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
AABBox2<T>::AABBox2(NsFloat32 minX, NsFloat32 minY, NsFloat32 maxX, NsFloat32 maxY): 
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
AABBox2<T>& AABBox2<T>::operator=(const AABBox2& v)
{
    mMin = v.mMin;
    mMax = v.mMax;
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
Vector2<T> AABBox2<T>::operator[](NsSize i) const
{
    NS_ASSERT(i < 4);
    return Vector2<T>(
        i & 1 ? mMax[0] : mMin[0],
...
{
    mMin[0] = Math::Min(box.mMin[0], mMin[0]);
    mMin[1] = Math::Min(box.mMin[1], mMin[1]);

    mMax[0] = Math::Max(box.mMax[0], mMax[0]);
    mMax[1] = Math::Max(box.mMax[1], mMax[1]);
...
{
    mMin[0] = Math::Min(point[0], mMin[0]);
    mMin[1] = Math::Min(point[1], mMin[1]);

    mMax[0] = Math::Max(point[0], mMax[0]);
    mMax[1] = Math::Max(point[1], mMax[1]);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
NsBool AABBox2<T>::operator==(const AABBox2<T>& box) const
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
NsBool AABBox2<T>::IsEmpty() const
{
...
const AABBox2<T> operator*(const AABBox2<T>& box, const Transform2<T>& mtx)
{
    ...
    for (NsSize i = 0; i < 2; i++)
    {
        for (NsSize j = 0; j < 2; j++)
        {
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
NsBool Inside(const AABBox2<T>& box, const Vector2<T>& p)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
NsBool BoxesIntersect(const AABBox2<T>& box0, const AABBox2<T>& box1)
{
...
{
    NsFloat32 minX = eastl::max_alt(b0.GetMin()[0], b1.GetMin()[0]);
    NsFloat32 maxX = eastl::min_alt(b0.GetMax()[0], b1.GetMax()[0]);

    NsFloat32 minY = eastl::max_alt(b0.GetMin()[1], b1.GetMin()[1]);
    NsFloat32 maxY = eastl::min_alt(b0.GetMax()[1], b1.GetMax()[1]);
