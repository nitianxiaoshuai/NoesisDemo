...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
NsBool IsAffine(const Matrix3<T>& m)
{
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
Matrix3<T> Orthonormalize(const Matrix3<T>& m)
{
    Matrix3<T> res;
    
    res[0] = Normalize(m[0]);
    res[1] = Normalize(m[1] - Dot(m[1], res[0]) * res[0]);
    res[2] = Normalize(m[2] - Dot(m[2], res[0]) * res[0] - Dot(m[2], res[1]) * res[1]);
...
////////////////////////////////////////////////////////////////////////////////////////////////////
template<class T>
NsBool IsAffine(const Matrix4<T>& m)
{
