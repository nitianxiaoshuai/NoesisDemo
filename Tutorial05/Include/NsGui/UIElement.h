...
NS_CFORWARD(Gui, DrawingContext)
NS_CFORWARD(Gui, Geometry)
NS_CFORWARD(Gui, Projection)
NS_CFORWARD(Gui, Transform)
NS_CFORWARD(Gui, CommandBinding)
NS_CFORWARD(Gui, InputBinding)
NS_CFORWARD(Gui, Mouse)
NS_CFORWARD(Gui, TouchScreen)
NS_CFORWARD(Gui, Keyboard)
NS_SFORWARD(Gui, EventArgs)
NS_SFORWARD(Gui, RoutedEventArgs)
NS_SFORWARD(Gui, DependencyPropertyChangedEventArgs)
NS_SFORWARD(Gui, KeyboardFocusChangedEventArgs)
NS_SFORWARD(Gui, KeyEventArgs)
NS_SFORWARD(Gui, MouseButtonEventArgs)
NS_SFORWARD(Gui, MouseEventArgs)
NS_SFORWARD(Gui, MouseState)
NS_SFORWARD(Gui, MouseWheelEventArgs)
NS_SFORWARD(Gui, SizeChangedInfo)
NS_SFORWARD(Gui, TextCompositionEventArgs)
NS_SFORWARD(Gui, TraversalRequest)
...
typedef Noesis::Core::Delegate<void (Core::BaseComponent*,
    const DependencyPropertyChangedEventArgs&)>  DependencyPropertyChangedEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const KeyboardFocusChangedEventArgs&)>
    KeyboardFocusChangedEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const MouseEventArgs&)> 
    MouseEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const KeyEventArgs&)> 
    KeyEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const MouseButtonEventArgs&)> 
    MouseButtonEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const MouseWheelEventArgs&)> 
    MouseWheelEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const TouchEventArgs&)>
    TouchEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const ManipulationStartingEventArgs&)>
    ManipulationStartingEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const ManipulationStartedEventArgs&)>
    ManipulationStartedEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const ManipulationDeltaEventArgs&)>
    ManipulationDeltaEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*,
    const ManipulationInertiaStartingEventArgs&)> ManipulationInertiaStartingEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const ManipulationCompletedEventArgs&)>
    ManipulationCompletedEventHandler;
typedef Noesis::Core::Delegate<void (Core::BaseComponent*, const TextCompositionEventArgs&)> 
...
enum LayoutFlag
{
    LayoutFlag_NeverMeasured            = 1 << 0,
    LayoutFlag_NeverArranged            = 1 << 1,
    LayoutFlag_ValidMeasure             = 1 << 2,
    LayoutFlag_ValidArrange             = 1 << 3,
    LayoutFlag_ValidRender              = 1 << 4,
    LayoutFlag_ValidTransforms          = 1 << 5,
    LayoutFlag_ClipNeeded               = 1 << 6,
    LayoutFlag_MaxSizeClips             = 1 << 7,
    LayoutFlag_IgnoreLayoutProperties   = 1 << 8,
    LayoutFlag_UseLayoutRounding        = 1 << 9,
    LayoutFlag_RenderPerFrame           = 1 << 10,
    LayoutFlag_InsideMeasure            = 1 << 11,
    LayoutFlag_InsideArrange            = 1 << 12,
    LayoutFlag_MeasureInsideArrange     = 1 << 13,
    LayoutFlag_NeedsFireSizeChanged     = 1 << 14
};
...
public:
    ...
    //@{
    NsBool GetAllowDrop() const;
    void SetAllowDrop(NsBool value);
    //@}
    ...
    /// element
    //@{
    NsBool GetClipToBounds() const;
    void SetClipToBounds(NsBool clipToBounds);
    //@}

    /// Gets or sets a value that indicates whether the element can receive focus.
    //@{
    NsBool GetFocusable() const;
    void SetFocusable(NsBool value);
    //@}

    /// Gets or sets a value indicating whether this element is enabled in the user interface
    //@{
    NsBool GetIsEnabled() const;
    void SetIsEnabled(NsBool enabled);
    //@}

    /// Indicates whether this element has the focus
    NsBool GetIsFocused() const;
    ...
    NsBool GetIsMouseDirectlyOver() const;
    ...
    //@{
    const Drawing::Point& GetRenderTransformOrigin() const;
    void SetRenderTransformOrigin(const Drawing::Point& origin);
    //@}
    ...
    //@{
    Noesis::Gui::Visibility GetVisibility() const;
    void SetVisibility(Noesis::Gui::Visibility visibility);
    //@}
    ...
    //@{
    NsBool GetIsManipulationEnabled() const;
    void SetIsManipulationEnabled(NsBool enabled);
    //@}

    /// Gets touch input manager
    TouchScreen* GetTouch() const;

    /// Attempts to force capture of a touch to this element
    NsBool CaptureTouch(NsUInt32 touchDevice);
    
    /// Attempts to release the specified touch device from this element
    NsBool ReleaseTouchCapture(NsUInt32 touchDevice);
    ...
    const Drawing::Size& GetDesiredSize() const;
     
    /// Gets calculated (during arrange) render size
    const Drawing::Size& GetRenderSize() const;

    /// Invalidates the measurement state (layout) for the element.
    void InvalidateMeasure();

    /// Indicates if measured size is valid
    NsBool IsMeasureValid() const;
    ...
    void Measure(const Drawing::Size& availableSize);
    ...
    void Arrange(const Drawing::Rect& finalRect);
    ...
    virtual NsBool MoveFocus(const TraversalRequest& request);
    ...
    virtual const Drawing::Size& GetMeasureConstraint() const;

    // Gets previous arrange constraint (internally used by Layout manager)
    virtual const Drawing::Rect& GetArrangeConstraint() const;
...
protected:
    ...
    //@{
    NsBool NeverMeasured() const;
    NsBool NeverArranged() const;
    //@}

    /// Indicates if element is being measured or arranged
    //@{
    NsBool IsInsideMeasure() const;
    NsBool IsInsideArrange() const;
    //@}

    /// Enqueues element for size changed
    void InvalidateSize(const Drawing::Size& oldSize, const Drawing::Size& newSize);

    /// Invalidates element for render
    void InvalidateRender();

    /// Indicates if render is valid
    NsBool IsRenderValid() const;

    /// Updates a layout flag
    //@{
    void SetLayoutFlag(NsUInt32 flag);
    void ClearLayoutFlag(NsUInt32 flag);
    //@}

    /// Checks if a flag is active
    NsBool CheckLayoutFlag(NsUInt32 flag) const;

    /// Rounds layout values
    //@{
    NsFloat32 RoundValue(NsFloat32 val) const;
    Drawing::Size RoundSize(const Drawing::Size& size) const;
    Drawing::Point RoundPoint(const Drawing::Point& point) const;
    Drawing::Rect RoundRect(const Drawing::Rect& rect) const;
    //@}

    /// Element finalization (it should be FE::Unloaded event)
    ...
    virtual Ptr<Geometry> GetLayoutClip(const Drawing::Size& layoutSlotSize) const;
    ...
    virtual Drawing::Size MeasureCore(const Drawing::Size& availableSize);

    /// Provides arrangement logic for placing child elements within this element
    virtual void ArrangeCore(const Drawing::Rect& finalRect);

    /// Gets a value that becomes the return value of IsEnabled in derived classes. 
    virtual NsBool IsEnabledCore() const;
    ...
    virtual void OnIsEnabledChanged(const DependencyPropertyChangedEventArgs& e);
    ...
    virtual void OnIsHitTestVisibleChanged(const DependencyPropertyChangedEventArgs& e);
    ...
    /// From Visual
    //@{
    Drawing::Rect GetContentBoundsCore() const;
    ...
    HitTestResult HitTestCore(const Drawing::Point& point);
    // protected override GeometryHitTestResult HitTestCore(GeometryHitTestParameters 
    //     hitTestParameters);
    //@}

protected:
    NsUInt32 mLayoutFlags;
    Drawing::Size mRenderSize;
...
private:
    ...
    EventHandler TryGetEventHandlerRecursive(const Core::TypeClass* typeClass, 
    ...
    void EnqueueSizeChanged(const Drawing::Size& prevSize, const Drawing::Size& newSize);
    ...
    //@{
    static void StaticOnTouchDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnTouchMove(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnTouchUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnTouchEnter(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnTouchLeave(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnGotTouchCapture(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnLostTouchCapture(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewTouchDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewTouchMove(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewTouchUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnManipulationStarting(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnManipulationStarted(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnManipulationDelta(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnManipulationInertiaStarting(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnManipulationCompleted(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnGotKeyboardFocus(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnGotMouseCapture(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnKeyDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnKeyUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnLostKeyboardFocus(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnLostMouseCapture(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseEnter(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseLeave(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseLeftButtonDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseLeftButtonUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseMove(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseRightButtonDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseRightButtonUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnMouseWheel(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewGotKeyboardFocus(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewKeyDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewKeyUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewLostKeyboardFocus(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseLeftButtonDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseLeftButtonUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseMove(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseRightButtonDown(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseRightButtonUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseUp(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewMouseWheel(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnPreviewTextInput(Core::BaseComponent* obj, const EventArgs& e);
    static void StaticOnTextInput(Core::BaseComponent* obj, const EventArgs& e);
    //@}

    static NsBool CoerceIsEnabled(const DependencyObject* object, const void* value, 
        void* coercedValue);
    static NsBool CoerceIsHitTestVisible(const DependencyObject* object, const void* value, 
        void* coercedValue);
...
private:
    Drawing::Size mDesiredSize;
    Drawing::Size mPreviousMeasureConstraint;
    Drawing::Rect mPreviousArrangeConstraint;
