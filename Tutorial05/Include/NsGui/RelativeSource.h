...
////////////////////////////////////////////////////////////////////////////////////////////////////
class NS_GUI_CORE_API RelativeSource: public Core::BaseComponent, public IMarkupExtension
{
public:
    ...
    RelativeSource(RelativeSourceMode mode, ResourceKeyType* type, NsInt level);
    ...
    //@{
    NsInt GetAncestorLevel() const;
    void SetAncestorLevel(NsInt level);
    //@}
...
private:
    ...
    NsInt mAncestorLevel;

    NS_DECLARE_REFLECTION(RelativeSource, Core::BaseComponent)
};
